...
class GNNLightning(pyl.LightningModule):
    ...
    def forward(self, data):
        ...
        same_ring_size_min = data['same_ring_size_min']
        paths2 = data['paths2']
        paths2_atom = data['paths2_atom']
        paths3_atom = data['paths3_atom']
...
if __name__ == '__main__':
    ...
    trainer = pyl.Trainer(
        logger=pyl.loggers.CSVLogger('./lightning_logs/logs.csv', 'big_trainvalid_path_atom3'),
        gpus=8,
        max_epochs=100,
        accelerator='ddp',
